...
public class AccountController {
    ...
    @GetMapping
    public ApiResponse<List<EmployeeAccountResponse>> findAll() {
        return ApiResponse.success("Lấy danh sách tài khoản nhân viên thành công", userService.findAllAccounts());
    }
